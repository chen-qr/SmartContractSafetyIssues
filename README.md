...
- 使用链下随机数：目前很多预言机平台提供链下不可预测的随机数生成，我在个人项目[Roulette-dApp](https://github.com/chen-qr/Roulette-dApp)中有使用。
- 多方生成随机数：多个参与方来提交多个生成随机数的种子，减少单一方控制随机数的风险。
- 延迟随机数生成：在一个区块中先提交请求，未来的区块再生成随机数，攻击者很难预测未来区块的状态。
