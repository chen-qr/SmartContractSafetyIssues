...
**案例**：2016年"The DAO"被攻击，攻击者利用重入漏洞，从DAO合约中反复提取资金，最终盗取了约360万个以太币。
...
例如，抢先交易攻击者监听到，用户A即将在去中心化交易所大量买入代币X，用户A的行为势必会推高代币X的价格。

那么，攻击者可以先以低价买入代币X，等用户A的交易推高价格后，再卖出代币X获利。这就是抢先交易者的获利机会。
